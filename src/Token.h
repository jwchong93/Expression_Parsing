...
//Will be update soon.
typedef enum {CURRENT_PROGRAM_COUNTER,LEFT_PARENTHESIS,RIGHT_PARENTHESIS,LOGIC_NOT,NOT_EQUAL,
			ADD,SUBTRACT,DIVIDE,MULTIPLY,MODULUS,POST_INCREMENT,PRE_INCREMENT,
			POST_DECREMENT,PRE_DECREMENT,EQUAL}Operation;
