...
//Will be update soon.
typedef enum {CURRENT_PROGRAM_COUNTER,LEFT_PARENTHESIS,RIGHT_PARENTHESIS,
			ADD,SUBTRACT,DIVIDE,MULTIPLY,MODULUS,POST_INCREMENT,PRE_INCREMENT,POST_DECREMENT,PRE_DECREMENT}Operation;
